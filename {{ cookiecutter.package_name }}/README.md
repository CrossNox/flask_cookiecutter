...
Add this badge to your readme: `[![Heroku](https://pyheroku-badge.herokuapp.com/?app={{ cookiecutter.package_name | replace("_", "-") }}&style=flat)](https://{{ cookiecutter.package_name | replace("_", "-") }}.herokuapp.com)`
